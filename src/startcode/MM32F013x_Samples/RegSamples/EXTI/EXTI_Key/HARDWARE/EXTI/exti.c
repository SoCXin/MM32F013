...
{
    RCC->APB2ENR |= RCC_APB2ENR_EXTI;       //enableAFIOclock
...
void EXTI0_1_IRQHandler(void)
{
    ...
    EXTI->PR = EXTI_PR_0; //clear LINE0interrupt  flag bit
#endif
#if defined (EMINIBOARD)
    if(KEY1 == 1) {
        LED1_TOGGLE();
    }
    EXTI->PR = EXTI_PR_1; //clear LINE0interrupt  flag bit
#endif
}
#if defined (EMINIBOARD)
void EXTI2_3_IRQHandler(void)
{
    ...
    EXTI->PR = EXTI_PR_2; //clear LINE0interrupt  flag bit
}
...
void EXTI4_15_IRQHandler (void)
{
    ...
    EXTI->PR = EXTI_PR_13; //clear LINE11interrupt  flag bit
    EXTI->PR = EXTI_PR_10; //clear LINE13interrupt  flag bit
}
