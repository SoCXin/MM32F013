...
void I2CInitMasterMode(void)
{
...
#endif
    I2C1->IC_CON = I2C_CR_MASTER | I2C_CR_STD | I2C_CR_REPEN | I2C_CR_SLAVEDIS | I2C_CR_EMPINT; // 0x163;
    ...
    GPIOB->AFRL |= (u32)((GPIO_AF_MODE1 << GPIO_AFRL_AFR6_Pos) | \
                         (GPIO_AF_MODE1 << GPIO_AFRL_AFR7_Pos)); //set PB6,PB7 AF to I2C SCK, SDA
#else //USING_MINIBOARD
    GPIOB->AFRH &= ~(GPIO_AFRH_AFR8 | GPIO_AFRH_AFR9);
    GPIOB->AFRH |= (u32)((GPIO_AF_MODE1 << GPIO_AFRH_AFR8_Pos) | \
                         (GPIO_AF_MODE1 << GPIO_AFRH_AFR9_Pos)); //set PB8,PB9 AF to I2C SCK, SDA
#endif
