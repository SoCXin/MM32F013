////////////////////////////////////////////////////////////////////////////////
/// @file    adc_tim1trig_dma_multichanit.c
/// @author  AE TEAM
...
#define _ADC_TIM1Trig_DMA_MultiChanIT_C_
...
////////////////////////////////////////////////////////////////////////////////
/// @addtogroup ADC_TIM1TRIG_DMA_MULTICHANIT
/// @{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_Trig_ADC_DMA_Init(void)
{
    LED_Init();
    DMAInit();
    ADCMultiChannelInit(&vchan[0], 3);
    ADC_ExternalTrigConvCmd(ADC1, ENABLE);
    Tim1_CC1_init((u16)(72000000 / 10000 - 1), 9);
}
...
void ADCMultiChannelInit(ADCch* pvchan, u8 number)
{
    ...
    for(i = 0; i < number; i++) {
        if((*pvchan) == (ADCch)ADC_Channel_TempSensor) {
            ADC_TempSensorVrefintCmd(ENABLE);
        }
        else if((*pvchan) == (ADCch)ADC_Channel_VoltReference) {
            ADC_TempSensorVrefintCmd(ENABLE);
        }
        else {
            ADCConfig(*pvchan);
