////////////////////////////////////////////////////////////////////////////////
/// @file    adc_tim1trig_dma_multichanit.h
/// @author  AE TEAM
...
#ifndef __ADC_TIM1Trig_DMA_MultiChanIT_H
#define __ADC_TIM1Trig_DMA_MultiChanIT_H
...
/// @{
#ifdef _ADC_TIM1Trig_DMA_MultiChanIT_C_
#define GLOBAL
...
GLOBAL u16 ADCFilterValue[3];
GLOBAL u8 ADCTrigFilterflag;
GLOBAL u16 varADCavarage[AVERAGELEN][3];
typedef enum {
