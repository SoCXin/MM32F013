...
// MM32 Library version is V1.0.1
...
// MM32 Library release date is 2020-08-17(YYYY-MM-DD)
#define __MM32_LIB_RELESE_YEARH         (0x20U)                                 //!< [31:24] release year high 
#define __MM32_LIB_RELESE_YEARL         (0x20U)                                 //!< [23:16] release year low
#define __MM32_LIB_RELESE_MONTH         (0x08U)                                 //!< [15:8]  release month
#define __MM32_LIB_RELESE_DAY           (0x17U)                                 //!< [7:0]   release day
